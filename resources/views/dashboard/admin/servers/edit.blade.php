    ...
    <div class="row justify-content-start">
        ...
        <div class="col-4">
            @if ($currentServer->logo_path)
					...
					@endif
					<form method="POST" action="{{'/dashboard/admin/server/' . $currentServer->slug . '/logo'}}" enctype="multipart/form-data">
						@csrf
        ...
        <div class="col-8">
            <form method="POST" action="{{ '/dashboard/admin/server/' . $currentServer->slug . '/edit'}}">
                @csrf
                @method('PATCH')
                <div class="card">
